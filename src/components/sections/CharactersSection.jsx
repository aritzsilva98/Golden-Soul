    ...
    <section className='characters-section pl-4'>
      {hasMyCharacters && (
        <div className='bg-amber-50 border-2 border-amber-700 rounded-lg p-6 shadow-lg mb-8'>
          <h2 className='text-xl font-bold mb-4 text-center sm:text-2xl md:text-3xl lg:text-4xl'>Personajes Jugadores</h2>
      ...
      {hasCharacters && (
        <div className='bg-amber-50 border-2 border-amber-700 rounded-lg p-6 shadow-lg mb-8'>
          <h2 className='text-2xl font-bold mb-4 text-center'>Personajes No Jugadores</h2>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 pb-4'>
